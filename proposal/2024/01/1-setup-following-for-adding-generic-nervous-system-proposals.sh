...
./quill sns \
  ...
  --type add-generic-nervous-system-function \
  ${NEURON_ID} > "./sns/proposal/2024/01/1-setup-following-for-adding-generic-nervous-system-proposals.json"

./quill send "./sns/proposal/2024/01/1-setup-following-for-adding-generic-nervous-system-proposals.json" --yes