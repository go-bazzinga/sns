...
./quill sns \
  ...
  --function-id 4001 \
  ${NEURON_ID} > "./sns/proposal/2024/01/3-setup-following-for-executing-generic-nervous-system-proposals.json"

./quill send "./sns/proposal/2024/01/3-setup-following-for-executing-generic-nervous-system-proposals.json" --yes