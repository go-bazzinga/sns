...
./quill sns \
    ...
    --vote ${VOTE} \
    ${NEURON_ID} > ./sns/proposal/2023/08/1-vote-on-token-transfer-proposal.json

./quill send --yes ./sns/proposal/2023/08/1-vote-on-token-transfer-proposal.json