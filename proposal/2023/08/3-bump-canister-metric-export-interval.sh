...
# "54f9ba2b0e81a17f5261b277abd91816e041c5ca749ba88b3dbe05f66bb6124d" > "./sns/proposal/2023/08/2-upgrade_${CANISTER_NAME}_canister_message.json"
# ./quill send "./sns/proposal/2023/08/2-upgrade_${CANISTER_NAME}_canister_message.json" --yes
...
./quill sns \
  ...
  --wasm-path "./.dfx/ic/canisters/${CANISTER_NAME}/${CANISTER_NAME}.wasm.gz" \
  --canister-upgrade-arg "(record {})" \
"54f9ba2b0e81a17f5261b277abd91816e041c5ca749ba88b3dbe05f66bb6124d" > "./sns/proposal/2023/08/3-bump-canister-metric-export-interval.json"
./quill send "./sns/proposal/2023/08/3-bump-canister-metric-export-interval.json" --yes
